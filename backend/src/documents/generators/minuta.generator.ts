import { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, AlignmentType, ImageRun, Footer, Header, WidthType, BorderStyle } from 'docx';
import * as fs from 'fs';
import * as path from 'path';

export async function generateMinutaDocx(data: any): Promise<Buffer> {
  const {
    municipio = 'BARROCAS',
    numeroContrato,
